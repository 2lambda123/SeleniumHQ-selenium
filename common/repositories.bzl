...
""",
    ...
    http_archive(
        ...
        url = "https://msedgedriver.azureedge.net/129.0.2766.0/edgedriver_linux64.zip",
        sha256 = "40119ecd985496cfbc69c8b11558f294e5d23a9fa207f7becf4dc9ee43b2729f",
        build_file_content = """
load("@aspect_rules_js//js:defs.bzl", "js_library")
package(default_visibility = ["//visibility:public"])
...
""",
    ...
    http_archive(
        name = "mac_edgedriver",
        url = "https://msedgedriver.azureedge.net/129.0.2766.0/edgedriver_mac64.zip",
        sha256 = "31782fa5ad3e13427ead948b76b03d9dde5718d78536716eeb33397f87853ccb",
        build_file_content = """
load("@aspect_rules_js//js:defs.bzl", "js_library")
package(default_visibility = ["//visibility:public"])
